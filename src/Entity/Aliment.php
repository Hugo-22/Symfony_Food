...
class Aliment
{
     ...
     * @Assert\Length(min=3, max=15, minMessage="Le nom doit faire 3 caractères minimum", maxMessage="Le nom doit faire 15 caractères au maximum")
     */
    private $nom;

    /**
     * @ORM\Column(type="float")
     * @Assert\Length(min=0.1, max=100)
     */
    private $prix;
